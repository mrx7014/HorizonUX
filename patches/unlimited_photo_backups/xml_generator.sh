...
cat >> ./patched_resources/product/etc/sysconfig/pixel_2016_exclusive.xml << EOF
<?xml version="1.0" encoding="utf-8"?>
	<!-- autogenerated by horizonux/patches/unlimited_photo_backups/xml_generator.sh -->
...
cat >> ./patched_resources/product/etc/sysconfig/pixel_2017_exclusive.xml << EOF
<?xml version="1.0" encoding="utf-8"?>
<!-- autogenerated by horizonux/patches/unlimited_photo_backups/xml_generator.sh -->
...
cat >> ./patched_resources/product/etc/sysconfig/pixel_2018_exclusive.xml << EOF
<?xml version="1.0" encoding="utf-8"?>
<!-- autogenerated by horizonux/patches/unlimited_photo_backups/xml_generator.sh -->
...
cat >> ./patched_resources/product/etc/sysconfig/pixel_experience_2019.xml << EOF
<?xml version="1.0" encoding="utf-8"?>
<!-- autogenerated by horizonux/patches/unlimited_photo_backups/xml_generator.sh -->
...
cat >> ./patched_resources/product/etc/sysconfig/pixel_experience_pulsecore.xml << EOF
<?xml version="1.0" encoding="utf-8"?>
<!-- autogenerated by horizonux/patches/unlimited_photo_backups/xml_generator.sh -->
<!-- These are configurations that should exist on all Pulse devices. -->
<config>
...
for useless_product_sysconfigs in 'pixel_2019_exclusive.xml' 'pixel_experience_2019_midyear.xml' 'pixel_experience_2020.xml' 'pixel_experience_2020_midyear.xml' 'pixel_experience_2021.xml' 'pixel_experience_2021_midyear.xml' 'pixel_experience_2022.xml' 'pixel_experience_2023.xml' 'pixel_experience_2023_midyear.xml'; do
    touch ./patched_resources/product/etc/sysconfig/$useless_product_sysconfigs
done

# Also create the new file to mark it as edited.
touch ./patched_resources/product/etc/sysconfig/pixel_experience_2024.xml