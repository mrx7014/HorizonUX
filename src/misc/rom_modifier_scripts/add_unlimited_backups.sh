...
mkdir -p "$HORIZON_PRODUCT_DIR/etc/sysconfig"
...
for useless_product_sysconfigs in 'pixel_2019_exclusive.xml' 'pixel_experience_2019_midyear.xml' 'pixel_experience_2020.xml' 'pixel_experience_2020_midyear.xml' 'pixel_experience_2021.xml' 'pixel_experience_2021_midyear.xml' 'pixel_experience_2022.xml' 'pixel_experience_2023.xml' 'pixel_experience_2023_midyear.xml'; do
    touch $HORIZON_PRODUCT_DIR/etc/sysconfig/$useless_product_sysconfigs
done

# Also create the new file to mark it as edited.
touch $HORIZON_PRODUCT_DIR/etc/sysconfig/pixel_experience_2024.xml

cat >> $HORIZON_PRODUCT_DIR/etc/sysconfig/pixel_2016_exclusive.xml << EOF
<?xml version="1.0" encoding="utf-8"?>
	<!-- autogenerated by HorizonXOneUI-HorizonUX/misc/scripts/add_unlimited_backups.sh -->
...
cat >> $HORIZON_PRODUCT_DIR/etc/sysconfig/pixel_2017_exclusive.xml << EOF
<?xml version="1.0" encoding="utf-8"?>
<!-- autogenerated by HorizonXOneUI-HorizonUX/misc/scripts/add_unlimited_backups.sh -->
...
cat >> $HORIZON_PRODUCT_DIR/etc/sysconfig/pixel_2018_exclusive.xml << EOF
<?xml version="1.0" encoding="utf-8"?>
<!-- autogenerated by HorizonXOneUI-HorizonUX/misc/scripts/add_unlimited_backups.sh -->
...
cat >> $HORIZON_PRODUCT_DIR/etc/sysconfig/pixel_experience_2019.xml << EOF
<?xml version="1.0" encoding="utf-8"?>
<!-- autogenerated by HorizonXOneUI-HorizonUX/misc/scripts/add_unlimited_backups.sh -->
...
cat >> $HORIZON_PRODUCT_DIR/etc/sysconfig/pixel_experience_horizoncore.xml << EOF
<?xml version="1.0" encoding="utf-8"?>
<!-- autogenerated by HorizonXOneUI-HorizonUX/misc/scripts/add_unlimited_backups.sh -->
